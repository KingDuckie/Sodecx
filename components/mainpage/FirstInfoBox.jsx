...
const Firstdescription = () => {
  ...
  return (
    <>
      <section className="bg-gray-50 dark:bg-gray-900 hidden md:block">
          ...
          <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
            ...
            <div className="text-gray-500 sm:text-lg dark:text-gray-400">
              <h2
                ...
                data-aos-easing="ease-in-out"
                data-aos-once="false"
                className="mb-4 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white"
              >
                {t("hofi7")}
              </h2>
      ...
      <section className="bg-gray-50 dark:bg-gray-900 md:hidden">
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
          <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
            <div className="text-gray-500 sm:text-lg dark:text-gray-400">
              ...
              <p className="mb-8 font-light lg:text-xl">{t("hofi6")}</p>
            </div>
          </div>
          ...
          <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
            ...
            <div className="text-gray-500 sm:text-lg dark:text-gray-400">
              ...
              <p className="mb-8 font-light lg:text-xl">{t("hofi8")}</p>
              ...
              <p className="font-light lg:text-xl">{t("hofi14")}</p>
            </div>
          </div>
        </div>
      </section>

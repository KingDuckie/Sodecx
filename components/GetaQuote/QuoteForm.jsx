            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div className="relative">
                  ...
                  >
                    <option disabled>{t("weqf10")}</option>
                    <option value="Starter">{t("weqf11")}</option>
                    <option value="Company">{t("weqf12")} </option>
                    <option value="Enterprise">{t("weqf13")}</option>
                    <option value="Custom">{t("weqf14")}</option>
                  </select>
